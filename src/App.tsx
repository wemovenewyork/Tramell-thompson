      ...
      <div className="hero-content">
        ...
        <div className="hero-social">
          ...
          <a href="https://www.youtube.com/channel/UCcGj78lfiLuDPxujO2AaHHw" target="_blank" rel="noreferrer" aria-label="YouTube">
            <svg viewBox="0 0 24 24"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.4 19.6C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z" /><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="#0E0E0E" /></svg>
          </a>
...
const topicFormats: string[] = [
  'Keynote & panels',
  'Broadcast & podcast interviews',
  'Union & labor convenings',
  ...
  return (
    <section className="topics" id="topics" aria-label="Speaking topics">
      <div className="topics-inner">
        ...
        <div className="topics-formats reveal">
          <span className="topics-formats-label">Available formats</span>
          <div className="topics-formats-tags">
            {topicFormats.map(f => (
              <span key={f} className="topic-tag">{f}</span>
            ))}
          </div>
        </div>

        <div className="topics-cta reveal">
          <a
            href="#book"
...
function DatePicker({ value, onChange }: { value: string; onChange: (date: string) => void }) {
  ...
  return (
    <div className="datepicker-wrap" ref={wrapRef}>
      <button
        type="button"
        className={`datepicker-trigger${value ? '' : ' placeholder'}${open ? ' open' : ''}`}
        onClick={() => setOpen(o => !o)}
      ...
      {open && (
        <div className="datepicker" role="dialog">
